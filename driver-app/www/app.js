...
(function () {
  ...
  function enrol() {
    ...
    if (!code) { err.textContent = 'Please enter the code from the office.'; err.hidden = false; return; }
    $('btnEnrol').disabled = true;
    apiFetch('/driver/enrol', { method: 'POST', body: { name: name, code: code, deviceId: state.deviceId, appVersion: APP_VERSION } })
      .then(function (data) {
